/**
 * MargoSzpont Extension - Popup Script
 * Handles license validation and bot injection
 */
            ...
            if (tab && tab.url.includes('margonem.pl')) {
                await chrome.scripting.executeScript({
                    ...
                    func: (licenseKey) => {
                        ...
                        console.log('🤖 MargoSzpont: License key saved to page');
                    },
                    args: [key]
                });
            }
...
injectBtn.addEventListener('click', async () => {
    try {
        ...
        // This allows access to page's global variables like g, hero, map
        await chrome.scripting.executeScript({
            target: { tabId: tab.id },
