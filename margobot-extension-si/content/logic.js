window.mapData = {}; // Placeholder from MargoSzpont Bot
window.MargonemAPI = {
  state: {
    bag: null,
    is_exping: false,
  ...
  navigation: {
    findShortestPath: function (_0x4ee390, _0x858534) {
      const _0xad4122 = window.MargonemAPI.state.navigation.locationData;
      _0x4ee390 = normalizeLocationName(_0x4ee390);
      _0x858534 = normalizeLocationName(_0x858534);
      if (!mapData[_0x4ee390] || !mapData[_0x858534]) {
        return {
          path: [],
          error: "Jedna z lokacji nie istnieje"
        };
      }
      const _0x4f061c = mapData[_0x4ee390].gateways.find(_0x471060 => normalizeLocationName(_0x471060.name) === _0x858534);
      if (_0x4f061c) {
        const _0x845680 = {
          x: _0x4f061c.x,
          y: _0x4f061c.y
        ...
        const _0x1ed7f5 = {
          currentMap: _0x4ee390,
          nextMap: _0x858534,
          gateway: _0x845680
        };
        const _0x161c68 = [_0x1ed7f5];
        const _0xf3c60c = {
          path: _0x161c68,
          distance: 1
        };
      ...
      const _0x109dbe = {};
      const _0x54528a = {};
      const _0x293e45 = new Set();
      Object.keys(mapData).forEach(_0x13994f => {
        _0x109dbe[_0x13994f] = Infinity;
        _0x54528a[_0x13994f] = null;
        _0x293e45.add(_0x13994f);
      });
      _0x109dbe[_0x4ee390] = 0;
      let _0x4d4241 = 0;
      const _0x6bc63b = 10000;
      while (_0x293e45.size > 0 && _0x4d4241 < _0x6bc63b) {
        _0x4d4241++;
        let _0x2d330c = null;
        let _0x190149 = Infinity;
        for (const _0x58b814 of _0x293e45) {
          if (_0x109dbe[_0x58b814] < _0x190149) {
            _0x190149 = _0x109dbe[_0x58b814];
            _0x2d330c = _0x58b814;
          }
        }
        if (_0x2d330c === null) {
        ...
        if (_0x2d330c === _0x858534) {
          break;
        }
        _0x293e45.delete(_0x2d330c);
        const _0x4310f6 = _0x5eb040(_0x2d330c);
        for (const _0x4434c6 of _0x4310f6) {
          if (!_0x293e45.has(_0x4434c6)) {
            continue;
          }
          const _0x13548e = _0x109dbe[_0x2d330c] + 1;
          if (_0x13548e < _0x109dbe[_0x4434c6]) {
            _0x109dbe[_0x4434c6] = _0x13548e;
            _0x54528a[_0x4434c6] = _0x2d330c;
          }
        }
      }
      if (_0x109dbe[_0x858534] === Infinity) {
        return {
          path: [],
      ...
      const _0x293618 = [];
      let _0x4158e5 = _0x858534;
      while (_0x54528a[_0x4158e5] !== null) {
        const _0x151ebc = _0x54528a[_0x4158e5];
    ...
    stopNavigation: function (_0x1215b8 = false) {
      const _0x39d437 = window.MargonemAPI.state.navigation;
      _0x39d437.abortNavigation = true;
      _0x39d437.isNavigating = false;
      _0x39d437.currentPath = null;
      _0x39d437.currentPathIndex = 0;
      _0x39d437.targetLocation = null;
      _0x39d437.lastMoveTime = null;
      if (_0x39d437.pathCheckInterval) {
        clearInterval(_0x39d437.pathCheckInterval);
        _0x39d437.pathCheckInterval = null;
      }
      let _0x314d27 = window.Engine;
      if (_0x314d27 && _0x314d27.hero) {
        const _0x420e9f = Math.floor(_0x314d27.hero.x || _0x314d27.hero.d && _0x314d27.hero.d.x);
        const _0x4fb24f = Math.floor(_0x314d27.hero.y || _0x314d27.hero.d && _0x314d27.hero.d.y);
        const _0x855778 = {
          x: _0x420e9f,
          y: _0x4fb24f
        };
        _0x314d27.hero.autoGoTo(_0x855778);
      }
      if (_0x1215b8) {
  ...
  combat: {
    ...
    _lockTimeouts: {},
    _activeSession: null,
    async _acquireLock(_0x1717ec, _0x16741d = 10000) {
      if (this._asyncLocks[_0x1717ec]) {
        return false;
      }
      this._asyncLocks[_0x1717ec] = true;
      this._lockTimeouts[_0x1717ec] = setTimeout(() => {
        console.warn("Force releasing lock: " + _0x1717ec + " due to timeout");
        this._releaseLock(_0x1717ec);
      }, _0x16741d);
      return true;
    },
    _releaseLock(_0x5793ac) {
      this._asyncLocks[_0x5793ac] = false;
      if (this._lockTimeouts[_0x5793ac]) {
        clearTimeout(this._lockTimeouts[_0x5793ac]);
        delete this._lockTimeouts[_0x5793ac];
      }
    },
    startFight: async function (_0x5b4383, _0x33b44c = 0) {
      if (!sessionToken) {
        return {
          success: false,
      ...
      const _0x5cffcf = this._activeSession;
      try {
        window.MargonemAPI.combat.stopRequested = false;
        const _0x44cdf7 = window.MargonemAPI.state;
        if (!_0x44cdf7.timers.combatIntervals) {
          _0x44cdf7.timers.combatIntervals = new Set();
        }
        if (!_0x44cdf7.timers.autoFightTimeouts) {
          _0x44cdf7.timers.autoFightTimeouts = new Set();
        }
        _0x44cdf7.blockedMobs.clear();
        _0x44cdf7.lastAttemptedMobs = [];
        _0x44cdf7.currentTargetId = null;
        _0x44cdf7.autoFightInProgress = false;
        _0x44cdf7.map_cleaned = false;
        _0x44cdf7.levelRange = {
          min: null,
          max: null
        };
        if (typeof _0x5b4383 === "object" && _0x5b4383.levelRange) {
          const _0x2b86fd = {
            min: _0x5b4383.levelRange.min || null,
            max: _0x5b4383.levelRange.max || null
          };
          _0x44cdf7.levelRange = _0x2b86fd;
          _0x44cdf7.selectedNicks = [];
        } else {
          _0x44cdf7.selectedNicks = Array.isArray(_0x5b4383) ? _0x5b4383 : [_0x5b4383];
        }
        _0x44cdf7.autoFightActive = true;
        try {
        ...
        if (_0x33b44c > 0) {
          _0x44cdf7.fightEndTime = Date.now() + _0x33b44c * 1000;
          _0x44cdf7.timers.fight = setTimeout(() => {
            if (_0x44cdf7.autoFightActive && this._activeSession === _0x5cffcf) {
        ...
        if (_0x44cdf7.autoFightActive && this._activeSession === _0x5cffcf) {
          window.MargonemAPI.combat.autoFight(_0x5cffcf);
        }
        const _0x27bb75 = {
          success: true,
          sessionId: _0x5cffcf
    ...
    stopFight: function () {
      const _0x59912a = window.MargonemAPI.state;
      const _0x142fdf = this._activeSession;
      this._activeSession = null;
      window.MargonemAPI.combat.stopRequested = true;
      _0x59912a.autoFightActive = false;
      _0x59912a.autoFightInProgress = false;
      _0x59912a.selectedNicks = [];
      _0x59912a.lastAttemptedMobs = [];
      _0x59912a.currentTargetId = null;
      _0x59912a.blockedMobs.clear();
      _0x59912a.map_cleaned = false;
      _0x59912a.levelRange = {
        min: null,
        max: null
      };
      window.MargonemAPI.combat.recoverySystem.stopMonitoring();
      if (_0x59912a.timers.fight) {
        clearTimeout(_0x59912a.timers.fight);
        _0x59912a.timers.fight = null;
      }
      if (_0x59912a.timers.update) {
        clearInterval(_0x59912a.timers.update);
        _0x59912a.timers.update = null;
      }
      if (_0x59912a.timers.autoFightTimeouts) {
        _0x59912a.timers.autoFightTimeouts.forEach(_0x2c3dd2 => clearTimeout(_0x2c3dd2));
        _0x59912a.timers.autoFightTimeouts.clear();
      }
      if (_0x59912a.timers.combatIntervals) {
        _0x59912a.timers.combatIntervals.forEach(_0xd0dfe4 => clearInterval(_0xd0dfe4));
        _0x59912a.timers.combatIntervals.clear();
      }
      if (_0x59912a.pendingStopActions) {
        _0x59912a.pendingStopActions.clear();
      }
      if (_0x59912a.activeIntervals) {
        _0x59912a.activeIntervals.forEach(_0x311b84 => clearInterval(_0x311b84));
        _0x59912a.activeIntervals.clear();
      }
      if (_0x59912a.activeTimeouts) {
        _0x59912a.activeTimeouts.forEach(_0x3e58e6 => clearTimeout(_0x3e58e6));
        _0x59912a.activeTimeouts.clear();
      }
  ...
  getGameState: function () {
    const _0x3cdbb7 = window.Engine;
    if (!_0x3cdbb7 || !_0x3cdbb7.hero || !_0x3cdbb7.map) {
      return null;
    }
    const _0x54e77c = _0x3cdbb7.hero;
    const _0x1fe314 = _0x3cdbb7.map;
    const _0x4e3254 = {
      name: _0x1fe314.d && _0x1fe314.d.name || "Unknown Map",
      pvp: _0x1fe314.d && _0x1fe314.d.pvp || 0,
      id: _0x1fe314.d && _0x1fe314.d.id || 0
    };
    return {
      hero: {
        x: Math.floor(parseFloat(_0x54e77c.x || _0x54e77c.d && _0x54e77c.d.x)),
        y: Math.floor(parseFloat(_0x54e77c.y || _0x54e77c.d && _0x54e77c.d.y)),
        nick: _0x54e77c.d && _0x54e77c.d.nick || "Unknown",
        gold: _0x54e77c.gold || _0x54e77c.d && _0x54e77c.d.gold,
        level: _0x54e77c.lvl || _0x54e77c.d && _0x54e77c.d.lvl,
        hp: _0x54e77c.warrior_stats && _0x54e77c.warrior_stats.hp || _0x54e77c.d && _0x54e77c.d.warrior_stats && _0x54e77c.d.warrior_stats.hp || 0,
        maxhp: _0x54e77c.warrior_stats && _0x54e77c.warrior_stats.maxhp || _0x54e77c.d && _0x54e77c.d.warrior_stats && _0x54e77c.d.warrior_stats.maxhp || 1,
        hpPercentage: Math.floor((_0x54e77c.warrior_stats && _0x54e77c.warrior_stats.hp || _0x54e77c.d && _0x54e77c.d.warrior_stats && _0x54e77c.d.warrior_stats.hp || 0) / (_0x54e77c.warrior_stats && _0x54e77c.warrior_stats.maxhp || _0x54e77c.d && _0x54e77c.d.warrior_stats && _0x54e77c.d.warrior_stats.maxhp || 1) * 100)
      },
      map: _0x4e3254,
